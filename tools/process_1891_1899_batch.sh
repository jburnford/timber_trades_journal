#!/bin/bash
# Process TTJ 1891-1899 batch for OCR
...
BATCH_DIR="$BASE_DIR/TTJ 1891-1899"
EXTRACT_DIR="$BASE_DIR/extracted_1891_1899"
OUTPUT_DIR="$BASE_DIR/ocr_ready"

echo "=================================================================="
echo "TTJ 1891-1899 BATCH PROCESSING PIPELINE"
echo "=================================================================="
echo ""
...
echo ""
echo "Years: 1891, 1893, 1895, 1899"
echo ""
echo "=================================================================="
echo ""
...
for zipfile in *.zip; do
    # Skip Dropbox attribute files
    if [[ "$zipfile" == *":com.dropbox.attrs" ]]; then
        continue
    fi
...
TOTAL_IMAGES=$(find "$OUTPUT_DIR" -name "*.png" -path "*/189[1359]/*" -o -name "*.png" -path "*/1899/*" 2>/dev/null | wc -l)
echo ""
